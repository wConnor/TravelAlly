...
namespace TravelAlly.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Transport",
                columns: new[] { "Id", "Carrier", "OperatesOnDays", "Type" },
                values: new object[] { 1, "South Western Railway", 21, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, null, new DateTime(2023, 1, 19, 8, 45, 0, 0, DateTimeKind.Unspecified), 5, 1 });

            migrationBuilder.InsertData(
                table: "StationPassing",
                columns: new[] { "Id", "ArrivalTime", "DepartureTime", "StationId", "TransportId" },
                values: new object[] { 2, new DateTime(2023, 1, 19, 9, 8, 0, 0, DateTimeKind.Unspecified), new DateTime(2023, 1, 19, 9, 9, 0, 0, DateTimeKind.Unspecified), 4, 1 });

            migrationBuilder.InsertData(
                table: "StationPassing",
                columns: new[] { "Id", "ArrivalTime", "DepartureTime", "StationId", "TransportId" },
                values: new object[] { 3, new DateTime(2023, 1, 19, 9, 41, 0, 0, DateTimeKind.Unspecified), null, 3, 1 });
