...
namespace TravelAlly.Controllers
{
    public class TransportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Carrier,DepartureTime,ArrivalTime")] Transport transport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Carrier,DepartureTime,ArrivalTime")] Transport transport)
        {
            if (id != transport.Id)
            {
                return NotFound();
